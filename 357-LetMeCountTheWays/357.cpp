...
int main(int argc, char** argv) {
    ...
    while(cin>>cambioActual){
    	if(cambioActual>mayorNumCalculado){
    		for(int i = mayorNumCalculado+1; i <= cambioActual ; i++){
    			//cout << "Calculo cuantas formas hay para " << i << " centimos" << endl;
    			...
    			//cout << "Obtengo " << formasDevolverCambio[4][i] << " posibilidades"<<endl;
    		}
    		mayorNumCalculado = cambioActual;
    	}
